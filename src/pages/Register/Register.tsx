...
//   changeSuccess,
//   changeErrorMessage,
// } from "../../../appSlices/registrationSlice";
...
const Register = () => {
  ...
  //   (state) => state?.rootReducer?.registrationReducer?.isToken
  // );
  // const success = useSelector(
  //   (state) => state?.rootReducer?.registrationReducer?.success
  // );
  // const errorMessage = useSelector(
  //   (state) => state?.rootReducer?.registrationReducer?.errorMessage
  // );
  ...
  //   dispatch(activate({ uid: authToken[0], token: authToken[1] }));
  // };
