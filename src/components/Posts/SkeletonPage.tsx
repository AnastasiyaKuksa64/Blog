import style from "../BigCard/cardList.module.scss";
...
const SkeletonPage = () => (
  ...
  >
    ...
    <rect x="7" y="366" rx="3" ry="3" width="589" height="25" />
    <rect x="7" y="403" rx="3" ry="3" width="589" height="25" />
    <rect x="7" y="443" rx="3" ry="3" width="589" height="25" />
    <rect x="7" y="480" rx="3" ry="3" width="589" height="25" />
    <rect x="7" y="519" rx="3" ry="3" width="589" height="25" />
  </ContentLoader>
);
